...
public class HdfsModule extends SenderModule implements HdfsProperties{
    ...
    public void configure(Binder binder) {
        ...
        binder.bind(String.class).annotatedWith(Names.named("hdfsUrl")).toInstance(args[2]+File.separator+lzoFileName);
        ...
        try {
            ...
            binder.bind(ISender.class).toConstructor(HdfsDispatcher.class.getConstructor(String.class,String.class)).in(Scopes.SINGLETON);
